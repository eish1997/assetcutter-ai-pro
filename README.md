...
- [x] Acceptance-as-production (D-round): smoke matrix skips ù?green; credits STRICT; vision/3D/storyboard via Gateway Jobs; doc scrub of async-batch / local 9001 paths
...
- [x] 3D preview PBR slot generate: override params panel (aspect/size/understand/count 1xù4); defaults keep preset aspect/size/understand; only explicit picks override
...
- **Workspace**: main asset canvas + function sidebar; content slot switches assets ù?presets; Project Agent dock (right)
