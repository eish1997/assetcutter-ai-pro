...
- [x] 3D preview PBR slot generate: override params panel (aspect/size/understand/count 1x–x4) forced over preset; `r2ApiUrl` same-origin so R2 publish keeps session cookies
