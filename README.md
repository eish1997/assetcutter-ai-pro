...
- [x] Workflow 3D lightbox: remember camera/view; GL/scene warm cache; close captures live frame onto card; companion grid thumbs overwrite stable keys (no `:fp` file spam)
