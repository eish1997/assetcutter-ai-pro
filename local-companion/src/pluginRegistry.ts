...
export function buildCapabilitiesPayload() {
  ...
  return {
    ...
    storage: {
      ...
      deleteAssetDirectory: 'DELETE /v1/projects/:projectId/asset-directories/:assetId',
      assetRelPath: 'assets/<assetId>/<filename> or legacy assets/<key>/object + visible asset.<ext>|model.<ext>',
      catalog: null,
