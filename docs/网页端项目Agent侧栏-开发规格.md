...
**版本**：v0.6.1（2026-07-10）  
**状态**：产品与架构对齐稿 + Agent 工程契约；**P0→U1** 舞台；**P1=可点名专家 + 可沉淀记忆**（非网页 Hermes）；子 Agent 进度卡仍后置；**模态芯片先保留，自动挡后置**；**商业级会话（1C+2A）见 §18**；**并行开发派活见 §11.1**  
**定位**：工作区**项目内**常驻的 IDE 式 Agent 面板；主 Agent 编排；专家可 `@` 点名，带 **Profile（身份）** 与 **Memory（沉淀记忆）**；聊天可调优、**专家工作室**可治理；交付分层见 §5.0；持久化与商业级会话见 **§17.10 / §18**；P0 硬度见 §16；专家工程见 **§17**。

**读者**

| 角色 | 建议阅读 |
|------|----------|
| 产品 | §1、§2（含 P16–P25）、§4.2、§5.0、§11.0、§15、§17.1、§17.9～§17.10、**§18** |
| 架构 / 前端 | §3、§5、§15、§16、**§17～§18**、§7～§11 |
| Agent 工程 / QA | **§16、§17、§18**、§12、§15.3 |
| 交接 | §2、§3、§13、§15～§18 |
