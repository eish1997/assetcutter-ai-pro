...
> **产品入口已废止（2026-08-25）。** 壳内管家是 dsh。真源：[`架构宪章-本地壳大楼租户.md`](./架构宪章-本地壳大楼租户.md)、[`dsh本地壳-可执行开发计划.md`](./dsh本地壳-可执行开发计划.md)。  
> 本文只留共享登录态门槛、`persist:assetcutter-team`、壳内工作台登录后的 MCP 验收口径。**禁止**再把旧 Copilot 校准成团队主入口。
