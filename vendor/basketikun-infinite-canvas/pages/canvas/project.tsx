...
import { requestEdit, requestGeneration, requestImageQuestion } from "@ic/services/api/image";
import { requestAudioGeneration, storeGeneratedAudio } from "@ic/services/api/audio";
import { createVideoGenerationTask, isVideoTaskFailed, storeGeneratedVideo, waitForVideoGenerationTask } from "@ic/services/api/video";
import { defaultConfig, useConfigStore, useEffectiveConfig } from "@ic/stores/use-config-store";
import { ensureImagePreview, uploadImage } from "@ic/services/image-storage";
import { uploadMediaFile, type UploadedFile } from "@ic/services/file-storage";
import { nanoid } from "nanoid";
import { getDataUrlByteSize, readImageMeta } from "@ic/lib/image-utils";
import { imageReferenceLabel } from "@ic/lib/image-reference-prompt";
import { canvasThemes, type CanvasBackgroundMode } from "@ic/lib/canvas-theme";
import { useAssetStore } from "@ic/stores/use-asset-store";
import { useThemeStore } from "@ic/stores/use-theme-store";
import { cropDataUrl, splitDataUrl, upscaleDataUrl } from "@ic/lib/canvas/canvas-image-data";
import { fitNodeSize, nodeSizeFromRatio } from "@ic/lib/canvas/canvas-node-size";
import { captureVideoFrame, type VideoFramePosition } from "@ic/lib/canvas/canvas-video-frame";
import { App, Button, Modal } from "antd";
import { NODE_DEFAULT_SIZE, getNodeSpec } from "@ic/constant/canvas";
import { ActiveConnectionPath, ConnectionPath } from "@ic/components/canvas/canvas-connections";
import { CanvasConfigComposer } from "@ic/components/canvas/canvas-config-composer";
import { CanvasConfigNodePanel } from "@ic/components/canvas/canvas-config-node-panel";
import { CanvasNodeContextMenu } from "@ic/components/canvas/canvas-context-menu";
import { CanvasNodeAngleDialog, type CanvasImageAngleParams } from "@ic/components/canvas/canvas-node-angle-dialog";
import { CanvasNodeCropDialog, type CanvasImageCropRect } from "@ic/components/canvas/canvas-node-crop-dialog";
import { CanvasNodeMaskEditDialog, type CanvasImageMaskEditPayload } from "@ic/components/canvas/canvas-node-mask-edit-dialog";
import { CanvasNodeSplitDialog, type CanvasImageSplitParams } from "@ic/components/canvas/canvas-node-split-dialog";
import { CanvasNodeUpscaleDialog, type CanvasImageUpscaleParams } from "@ic/components/canvas/canvas-node-upscale-dialog";
import { buildNodeGenerationContext, buildNodeGenerationInputs, buildNodeResponseMessages, hydrateNodeGenerationContext, type NodeGenerationInput } from "@ic/components/canvas/canvas-node-generation";
...
import { CanvasNodePromptPanel, type CanvasNodeGenerationMode } from "@ic/components/canvas/canvas-node-prompt-panel";
import { CanvasToolbar } from "@ic/components/canvas/canvas-toolbar";
import { AssetPickerModal, type InsertAssetPayload } from "@ic/components/canvas/asset-picker-modal";
import { CanvasSidePanel } from "@ic/components/canvas/canvas-side-panel";
import { CanvasZoomControls } from "@ic/components/canvas/canvas-zoom-controls";
import { useAgentStore } from "@ic/stores/use-agent-store";
import { useCanvasStore } from "@ic/stores/canvas/use-canvas-store";
import { useAgentBridge } from "@ic/pages/canvas/hooks/use-agent-bridge";
import { usePluginHost } from "@ic/pages/canvas/hooks/use-plugin-host";
import { buildNodeMentionReferences, getGroupResourceNodes, isCanvasReferenceNode, type CanvasResourceReference } from "@ic/lib/canvas/canvas-resource-references";
import { exportCanvasProjects } from "@ic/lib/canvas/canvas-export";
import { applyNodeConfigPatch, audioMetadata, buildAudioGenerationMetadata, buildImageGenerationMetadata, createCanvasNode, imageMetadata, videoMetadata } from "@ic/lib/canvas/canvas-node-factory";
import { applyGroupSelection, applyUngroupSelection, canGroupSelectedNodes, canUngroupSelectedNodes, collectGroupMemberNodes, findContainingGroupId, findGroupDropTarget, getConnectionTargetAnchor, getGroupWrapRect, normalizeConnection, snapNodesIntoGroup } from "@ic/lib/canvas/canvas-node-geometry";
import {
    audioExtension,
    buildAngleLabel,
    buildAnglePrompt,
...
} from "@ic/lib/canvas/canvas-generation-helpers";
import { getNodeDefinition, isBuiltinNodeType as isBuiltinType, useNodeRegistryVersion } from "@ic/lib/canvas/node-registry";
import { registerBuiltinNodes } from "@ic/components/canvas/nodes/builtin-nodes";
import { CanvasPluginManagerModal } from "@ic/components/canvas/canvas-plugin-manager-modal";
import { CanvasRefreshShell } from "@ic/components/canvas/canvas-refresh-shell";
import { CanvasTopBar } from "@ic/components/canvas/canvas-top-bar";
...
import type { ReferenceImage } from "@ic/types/image";
import type { ReferenceAudio, ReferenceVideo } from "@ic/types/media";
