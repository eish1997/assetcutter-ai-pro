...
import type { CanvasAgentOp } from "@ic/lib/canvas/canvas-agent-ops";
import type { CanvasTheme } from "@ic/lib/canvas-theme";
import type { CanvasConnection, CanvasNodeData, CanvasNodeMetadata } from "@ic/types/canvas";
import type { CanvasResourceKind } from "@ic/lib/canvas/canvas-resource-references";
