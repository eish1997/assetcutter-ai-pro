import type { AiTextMessage } from "@ic/services/api/image";
...
import { CanvasNodeType, type CanvasConnection, type CanvasNodeData } from "@ic/types/canvas";
import { getGenerationResourceNodes, getGroupResourceNodes } from "@ic/lib/canvas/canvas-resource-references";
...
export async function hydrateNodeGenerationContext(context: NodeGenerationContext) {
    const { imageToDataUrl } = await import("@ic/services/image-storage");
