...
import { installPluginFromUrl, setPluginEnabled, uninstallPlugin, updatePlugin } from "@ic/lib/canvas/plugin-loader";
import { fetchOfficialPlugins, hasUpgrade, type OfficialPluginEntry } from "@ic/lib/canvas/plugin-registry";
import { useThemeStore } from "@ic/stores/use-theme-store";
import { usePluginStore, type InstalledPlugin } from "@ic/stores/canvas/use-plugin-store";
