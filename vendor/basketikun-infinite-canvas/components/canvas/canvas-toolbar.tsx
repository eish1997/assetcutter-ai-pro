...
import { canvasThemes, type CanvasBackgroundMode, type CanvasColorTheme, type CanvasTheme } from "@ic/lib/canvas-theme";
import { getNodePluginId, listNodeDefinitions, useNodeRegistryVersion } from "@ic/lib/canvas/node-registry";
import { useThemeStore } from "@ic/stores/use-theme-store";
import { AnimatedThemeToggler } from "@ic/components/ui/animated-theme-toggler";
...
export function CanvasToolbar({
    ...
    return (
        <div ref={rootRef} className="pointer-events-none absolute bottom-5 z-50 flex justify-center" style={{ left: 16, right: 16 }}>
