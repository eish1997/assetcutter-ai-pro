...
import { canvasThemes, type CanvasTheme } from "@ic/lib/canvas-theme";
import { exportCanvasNodes } from "@ic/lib/canvas/canvas-export";
import { getNodeDefinition } from "@ic/lib/canvas/node-registry";
import { cn } from "@ic/lib/utils";
import { PromptDetailDialog } from "@ic/pages/prompts/components/prompt-detail-dialog";
import { fetchSourcePrompts, type Prompt } from "@ic/services/api/prompts";
import { uploadMediaFile } from "@ic/services/file-storage";
import { previewUrlFor, subscribeImagePreviews, getImagePreviewRevision, uploadImage } from "@ic/services/image-storage";
import { useAssetStore, type Asset, type AssetKind } from "@ic/stores/use-asset-store";
import { usePromptSourceStore } from "@ic/stores/use-prompt-source-store";
import { CANVAS_SIDE_PANEL_MAX_WIDTH, CANVAS_SIDE_PANEL_MIN_WIDTH, CANVAS_SIDE_PANEL_MOTION_MS, useCanvasSidePanelStore } from "@ic/stores/use-canvas-side-panel-store";
import { useThemeStore } from "@ic/stores/use-theme-store";
import { CanvasNodeType, type CanvasNodeData } from "@ic/types/canvas";
