import { defaultConfig, resolveModelForCapability, type AiConfig } from "@ic/stores/use-config-store";
import i18n from "@ic/i18n";
import { ensureImagePreview, resolveImageUrl, uploadImage } from "@ic/services/image-storage";
import { resolveMediaUrl } from "@ic/services/file-storage";
import { imageMetadata, referenceUrl } from "@ic/lib/canvas/canvas-node-factory";
import type { NodeGenerationInput } from "@ic/components/canvas/canvas-node-generation";
import type { CanvasNodeGenerationMode } from "@ic/components/canvas/canvas-node-prompt-panel";
import type { CanvasImageAngleParams } from "@ic/components/canvas/canvas-node-angle-dialog";
import type { ReferenceImage } from "@ic/types/image";
import { CanvasNodeType, type CanvasAssistantSession, type CanvasConnection, type CanvasNodeData, type CanvasNodeMetadata } from "@ic/types/canvas";
