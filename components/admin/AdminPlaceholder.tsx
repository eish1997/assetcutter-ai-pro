...
const AdminPlaceholder: React.FC = () => {
  return (
    <div className="max-w-lg space-y-4 rounded-2xl border border-white/10 bg-white/[0.03] p-8">
      ...
      <p className="text-[11px] text-gray-500 leading-relaxed">
        ...
        <code className="bg-white/10 px-1 rounded text-[10px]">server/gemini-proxy-api.js</code>。
      </p>
    </div>
  );
};
