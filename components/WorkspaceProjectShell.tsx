      ...
      <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 shrink-0">
          ...
          <button
            ...
            className="px-5 py-2.5 rounded-xl bg-[#1c1c22] border border-[#2e2e32] text-[10px] font-black uppercase tracking-widest text-gray-200 hover:bg-[#2a2a31] transition-colors duration-200 cursor-pointer outline-none focus-visible:ring-2 focus-visible:ring-blue-400/70"
          >
            导入项目
          </button>
        </div>
            ...
            >
              ...
              <div className="p-4 flex items-start justify-between gap-2 border-t border-[#252528]">
                ...
                <button
                  ...
                  className="shrink-0 p-2 rounded-lg text-cyan-300/80 hover:text-cyan-200 hover:bg-[#16333f] border border-transparent hover:border-cyan-500/40 transition-colors duration-200 cursor-pointer outline-none focus-visible:ring-2 focus-visible:ring-cyan-500/40"
                  title="导出项目（分享用）"
