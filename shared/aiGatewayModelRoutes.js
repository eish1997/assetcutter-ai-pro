export const AI_GATEWAY_MODEL_ROUTE_EXECUTABLE_RULES = Object.freeze([
  {
    ...
    excludedModelPatterns: Object.freeze([/^gemini-3-pro-preview$/i]),
    modalities: Object.freeze(['text', 'image']),
    // vertex/aistudio = native Gemini paths; 302/aihubmix = OpenAI-compatible /v1 aggregators
    catalogProviderIds: Object.freeze(['vertex-site', 'gemini-aistudio', '302ai', 'aihubmix']),
    gatewayProviderIds: Object.freeze(['vertex-site', 'gemini-aistudio', '302ai', 'aihubmix']),
...
export const AI_GATEWAY_MODEL_ROUTE_PENDING_RULES = Object.freeze([
  {
    id: 'gemini-3-pro-preview-pending',
    modelPattern: /^gemini-3-pro-preview$/i,
    modalities: Object.freeze(['text']),
    catalogProviderIds: Object.freeze(['vertex-site', 'gemini-aistudio', '302ai', 'aihubmix']),
    gatewayProviderIds: Object.freeze(['vertex-site', 'gemini-aistudio', '302ai', 'aihubmix']),
