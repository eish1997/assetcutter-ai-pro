...
export const CHANNEL_CATALOG: readonly ChannelCatalogRow[] = [
  ...
  },
  {
    ...
    label: "302.AI / OpenAI 兼容",
    family: "openai",
    needsApiKey: true,
    needsBaseUrl: true,
    baseUrlPlaceholder: "https://api.302.ai/v1",
    keyPlaceholder: "302.AI API Key",
    hint: "302.AI OpenAI-compatible /v1；可承载 GPT 与 Gemini（改 model id）文/图路由。",
  },
  {
    channel: "aihubmix-openai",
    label: "AIHubMix / OpenAI 兼容",
    family: "openai",
    needsApiKey: true,
    needsBaseUrl: true,
    baseUrlPlaceholder: "https://aihubmix.com/v1",
    keyPlaceholder: "AIHubMix API Key",
    hint: "AIHubMix OpenAI-compatible /v1；可承载 GPT 与 Gemini（改 model id）文/图路由。",
  },
  {
