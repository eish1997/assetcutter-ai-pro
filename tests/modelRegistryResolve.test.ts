...
import type { UpstreamProviderId } from "../services/modelRegistry/types";

describe("modelRegistry resolve", () => {
  it("VectorEngine text: preview ids map to 2.5", () => {
    const p = "vectorengine" as UpstreamProviderId;
  ...
  it("Gemini official path: text unchanged", () => {
    const p = "gemini" as UpstreamProviderId;
  ...
  it("OpenAI: Gemini-style ids map to gpt models", () => {
    const p = "openai" as UpstreamProviderId;
  ...
  it("Antigravity image: preview suffix stripped to console ids", () => {
    const p = "antigravity" as UpstreamProviderId;
